...
def _build_step(
    ...
    build_ctx = StepBuildContext(
        ...
        qg_min_content_len=config.quality_gate.min_content_len,
        qg_min_paragraphs=config.quality_gate.min_paragraphs,
        qg_max_boilerplate_ratio=config.quality_gate.max_boilerplate_ratio,
        qg_max_code_ratio=config.quality_gate.max_code_ratio,
        qg_min_unique_words=config.quality_gate.min_unique_words,
